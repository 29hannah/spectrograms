...
#Distance 1
sound_file_paths = [f for f in abs_file_paths("/Users/hannahsmacbook/Stimuli_J/dis_1")]
res_list_1 = []
...
#Distance 2
sound_file_paths = [f for f in abs_file_paths("/Users/hannahsmacbook/Stimuli_J/dis_2")]
res_list_2 = []
for sound_file_path in sound_file_paths:
    sound = slab.Binaural(sound_file_path)
    cen = sound.spectral_feature(feature='centroid')
...
#Distance 3
sound_file_paths = [f for f in abs_file_paths("/Users/hannahsmacbook/Stimuli_J/dis_3")]
res_list_3 = []
for sound_file_path in sound_file_paths:
    sound = slab.Binaural(sound_file_path)
    cen = sound.spectral_feature(feature='centroid')
...
#Distance 4
sound_file_paths = [f for f in abs_file_paths("/Users/hannahsmacbook/Stimuli_J/dis_4")]
res_list_4 = []
for sound_file_path in sound_file_paths:
    sound = slab.Binaural(sound_file_path)
    cen = sound.spectral_feature(feature='centroid')
...
#Distance 5
sound_file_paths = [f for f in abs_file_paths("/Users/hannahsmacbook/Stimuli_J/dis_5")]
res_list_5 = []
for sound_file_path in sound_file_paths:
    sound = slab.Binaural(sound_file_path)
    cen = sound.spectral_feature(feature='centroid')
